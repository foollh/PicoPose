import sys
sys.path.append('/cluster/personal/myprojects/NovelObjectRenderer/gigapose/')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cad_path", default='/cluster/sc_download/bop_datasets/lmo/models/obj_000005.ply', help="Path to the model file")
    parser.add_argument("--obj_pose", default='/cluster/sc_download/bop_datasets/templates/lmo_normalize/object_poses/000005.npy', help="Path to the model file")
    parser.add_argument(
        "--output_dir", default='/cluster/sc_download/bop_datasets/templates/lmo_normalize/000005', help="Path to where the final files will be saved"
    )
    parser.add_argument("--gpus_devices", default="1", help="GPU devices")
